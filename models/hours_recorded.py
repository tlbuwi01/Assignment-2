...
class HoursRecorded(db.Model):
    ...
    def __init__(self, studentID,staffID, amount,confirmed, description=None):
    ...
    def __repr__(self):
        return f"<HoursRecorded {self.recordId} - Student {self.studentID} - Amount: {self.amount} - Confirmed: {self.confirmed}>"
